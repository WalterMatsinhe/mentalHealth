  ...
  const services = [
    {
      ...
      description:
        "One-on-one counseling sessions with licensed therapists specializing in anxiety, depression, trauma, and personal growth.",
      features: [
        "50-minute sessions",
        "Weekly or bi-weekly",
    ...
    },
    {
      ...
      title: "Group Therapy",
      description:
        "Supportive group sessions focusing on shared experiences and peer support in a safe, confidential environment.",
      features: [
    ...
    },
    {
      ...
      description:
        "24/7 emergency mental health support for individuals experiencing acute psychological distress or crisis situations.",
    ...
    },
    {
      ...
      description:
        "Preventive mental health programs including stress management, mindfulness training, and resilience building.",
      features: [
        "Workshops & seminars",
  ...
  const resources = [
    {
      ...
      description:
        "Quick screening tools for anxiety, depression, and stress levels",
    },
    {
      title: "Mental Health Library",
      description:
        "Educational articles, videos, and guides on various mental health topics",
    },
    {
    ...
    },
    {
      ...
      description:
        "Find local and online support groups for specific conditions",
    },
    {
      title: "Emergency Resources",
      description: "Crisis hotlines and immediate help resources",
    },
    {
      title: "Family & Friends Guide",
      description:
        "Resources for supporting loved ones with mental health challenges",
    },
  ];
  ...
  return (
    <>
      ...
      <div className="flex flex-col min-h-screen ">
        ...
        <div
          id="hero"
          className="relative w-full h-[600px] overflow-hidden scroll-mt-24"
        >
        ...
        <div className="flex flex-row flex-1 w-full">
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-green-500 pl-4">
                  ...
                  <p className="text-sm text-foreground/70">
                    Take 5 minutes today to focus on your breathing and be
                    present.
                  </p>
                </div>
                <div className="border-l-4 border-blue-500 pl-4">
                  ...
                  <p className="text-sm text-foreground/70">
                    Reach out to a friend or family member you haven't spoken to
                    recently.
                  </p>
                </div>
          ...
          <main className="flex-1 px-8 max-w-7xl mx-auto">
            {/* Services Section */}
            <section id="services" className="mb-24 mt-6 scroll-mt-16">
            ...
            {/* Resources Section */}
            <section id="resources" className="mb-13 pt-8 scroll-mt-24">
              <h2 className="text-5xl font-bold text-foreground mb-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {resources.map((resource, index) => (
                  <div
                    key={index}
                    className="bg-card rounded-lg shadow-md p-4 hover:shadow-lg transition-shadow border-l-4 border-primary"
                  >
                    <h4 className="text-lg font-semibold text-primary-font mb-2">
                      {resource.title}
                    </h4>
                    <p className="text-primary-font/70 text-sm mb-3">
                      {resource.description}
                    </p>
                    <a
                      href="#"
                      className="text-primary-font hover:text-primary-font text-sm font-medium"
                    >
                      Access Resource →
                    </a>
                  </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <div className="mt-4 bg-primary/10 border border-primary/30 rounded-lg p-4">
                    ...
                    <p className="text-primary/80 text-sm">
                      Crisis Text Line for immediate text-based support
                    </p>
                  </div>
                </div>
              </div>
